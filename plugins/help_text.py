...
def help_user(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🔗 JOIN OUR CHANNEL 🔗", url="https://t.me/VKPROJECTS")]]),
        parse_mode="html",
...
def about(bot, update):
    ...
    bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="💸Donate", url="https://t.me/VKBOTSSUPPORTBOT")]]),
        parse_mode="html",
        reply_to_message_id=update.message_id,
        disable_web_page_preview=True   
    ) 
